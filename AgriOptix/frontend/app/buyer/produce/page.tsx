...
type FarmerQuality = {
  ...
  size?: string;
  freshness?: string;
  estimated_shelf_life?: string | number;
};
...
type Harvest = {
  ...
  farmer_reported_quality?: FarmerQuality;
  ...
  ai_quality_analysis?: AIQuality | null;
...
export default function AvailableProduce() {
  ...
  useEffect(() => {
    ...
    async function loadHarvests() {
      try {
        const response = await api("/api/harvests", {
          method: "GET",
          cache: "no-store",
        });
        ...
        setHarvests(Array.isArray(response) ? response : []);
      } catch (error) {
      ...
      <div className="buyers">
        {loading ? (
          ...
          harvests.map((harvest) => {
            const farmer: FarmerQuality =
              harvest.farmer_reported_quality || {
                ...
                <section className="quality-section ai-section">
                  ...
                  {ai ? (
                    ...
                    <p className="not-analyzed">
                      AI analysis has not been
                      completed for this harvest
                      yet.
                    </p>
                  )}
                </section>
