  ...
  return (
    ...
    >
      <div className="buyers">
          ...
          return (
            <div className="card buyer" key={harvest.id}>
              <div className="buyer-top">
                <b>{harvest.crop || "Produce"}</b>
                <span>
                  {harvest.quantity_kg ?? harvest.quantity} kg available
                </span>
              </div>
              ...
              <section className="quality-section">
                ...
                <div className="quality-grid">
                  <span>
                    Overall: <b>{farmer.overall_quality || "—"}</b>
                  </span>

                  <span>
                    Ripeness: <b>{farmer.ripeness || "—"}</b>
                  </span>

                  <span>
                    Visible Damage: <b>{farmer.visible_damage || "—"}</b>
                  </span>

                  <span>
                    Size: <b>{farmer.size || "—"}</b>
                  </span>

                  <span>
                    Freshness: <b>{farmer.freshness || "—"}</b>
                  </span>

                  <span>
                    Shelf Life:{" "}
                    <b>{farmer.estimated_shelf_life || "—"}</b>
                  </span>
                </div>
              </section>
              ...
              <section className="quality-section ai-section">
                ...
                {ai ? (
                  <>
                    <div className="quality-grid">
                      <span>
                        Crop Name: <b>{ai.crop_name}</b>
                      </span>

                      <span>
                        Overall Quality: <b>{ai.overall_quality}</b>
                      </span>

                      <span>
                        Visible Damage: <b>{ai.visible_damage}</b>
                      </span>

                      <span>
                        Ripeness / Maturity:{" "}
                        <b>{ai.ripeness_maturity}</b>
                      </span>
                      ...
                      <span>
                        Freshness / Condition:{" "}
                        <b>{ai.freshness_condition}</b>
                      </span>

                      <span>
                        Estimated Shelf Life:{" "}
                        <b>{ai.estimated_shelf_life}</b>
                      </span>

                      <span>
                        AI Confidence: <b>{ai.confidence}%</b>
                      </span>
                    </div>

                    {Array.isArray(harvest.photos) &&
                  ...
                  <p className="not-analyzed">
                    AI analysis has not been completed for this harvest yet.
                  </p>
                )}
              </section>
            </div>
        ...
        {!harvests.length ? (
          <div className="empty">
            No published harvests are available yet.
          </div>
        ) : null}
      </div>
